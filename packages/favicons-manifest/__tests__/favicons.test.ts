...
import favicons from "../src/index"
...
describe("favicons", () => {
    it("generate images, html and manifest based on logo.png", async () => {
        expect.assertions(1)

        const data = await favicons(path.join(__dirname, "fixtures", "logo.png"), {
            generators: {
                html: true,
                manifest: true,
                browserconfig: true,
